...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxAppcompatLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxAppcompatLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for appcompat14 (androidx.appcompat:appcompat)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            public Provider<MinimalExternalModuleDependency> getAppcompat14() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("androidx.appcompat.appcompat14");
        }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        private final AndroidxAppcompatVersionAccessors vaccForAndroidxAppcompatVersionAccessors = new AndroidxAppcompatVersionAccessors(providers, config);
        public AndroidxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.androidx.appcompat
         */
        public AndroidxAppcompatVersionAccessors getAppcompat() {
            return vaccForAndroidxAppcompatVersionAccessors;
        }

    }

    public static class AndroidxAppcompatVersionAccessors extends VersionFactory  {

        public AndroidxAppcompatVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: androidx.appcompat.appcompat13 (1.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAppcompat13() { return getVersion("androidx.appcompat.appcompat13"); }
